...
static void test_ota_dispatch_idle(void) {
    TEST_ASSERT_TRUE(cooking_logic_cycle_inactive(COOKING_STATE_IDLE));
}

/* ── test_ota_dispatch_done ─────────────────────────────────────────────── */

static void test_ota_dispatch_done(void) {
    TEST_ASSERT_TRUE(cooking_logic_cycle_inactive(COOKING_STATE_DONE));
}

/* ── test_ota_dispatch_error ────────────────────────────────────────────── */

static void test_ota_dispatch_error(void) {
    TEST_ASSERT_TRUE(cooking_logic_cycle_inactive(COOKING_STATE_ERROR));
}

/* ── test_ota_defer_preheat ─────────────────────────────────────────────── */

static void test_ota_defer_preheat(void) {
    TEST_ASSERT_FALSE(cooking_logic_cycle_inactive(COOKING_STATE_PREHEAT));
}

/* ── test_ota_defer_cooking ─────────────────────────────────────────────── */

static void test_ota_defer_cooking(void) {
    TEST_ASSERT_FALSE(cooking_logic_cycle_inactive(COOKING_STATE_COOKING));
}
